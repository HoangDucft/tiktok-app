...
function useModalReport(ModalComponent) {
    const [isShow, setIsShow] = useState(false);

    const MODAL_REPORT_MENU = [
        {
    ...
    const ModalExport = () => {
        return (
            isShow &&
            createPortal(<ModalComponent handleClose={modalHide} modalReportMenu={MODAL_REPORT_MENU} />, document.body)
        );
    };
